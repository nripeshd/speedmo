(function (factory) {
  ...
  var ProductVariants = /*#__PURE__*/function () {
    ...
    _createClass(ProductVariants, [{
      ...
      value: function _updateInventory(newVariant, previousVariant) {
...
//           Tejashwani 23/01/2021 Start:   Adding for ordernote
//              variantInventoryOrdernote = this.variantsInventories[newVariant['id']]['_ordernote'],
//           Tejashwani 23/01/2021 End:   Adding for ordernote			
        ...
        if (newVariant['available']) {
          if (null !== variantInventoryManagement ) {
...
//         productFormInventoryElement.innerHTML = "Test";
